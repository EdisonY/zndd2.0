<template>
    <div class="configuration command meter linetone">
        <div class="search">
            <ul>
                <li>
                    <label>
            ...
            <div class="f_right">
                ...
                <el-button type="primary" size="small" icon="el-icon-switch-button" :loading="loading" @click="generation()">批量生成施工命令</el-button>
            </div>
        </div>
        <div class="bj">
            <el-table
                ...
                <el-table-column
                    ...
                    <template #default="scope">
                        ...
                        <el-button
                            plain
                            size="small">
                            <router-link to="/construction/declare">变更</router-link>
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
